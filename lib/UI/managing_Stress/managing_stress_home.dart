...
class managing_stress_home extends StatefulWidget {
  const managing_stress_home({super.key});

  @override
  State<managing_stress_home> createState() => _managing_stress_homeState();
}

class _managing_stress_homeState extends State<managing_stress_home> {
  _initData() {}
