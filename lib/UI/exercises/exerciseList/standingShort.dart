...
class standingShort extends StatefulWidget {
  const standingShort({super.key});

  @override
  State<standingShort> createState() => _standingShortState();
}

class _standingShortState extends State<standingShort> {
  _initData() {}
              ...
              Container(
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    Text(
                      "1. Begin standing with your feet shoulder-width apart, arms extended out to the side.                                                                                                                                                                                                                                                                                                                                                                                            ",
                      style: TextStyle(
                        color: Color(0xFF77381F),
                        fontWeight: FontWeight.w500,
                      ),
                    ...
                    Text(
                      "2. Hinge forward at your waist, lowering your torso down while reaching your left hand toward your opposite foot.                                                                                                                                                                                                                                                                                                                                   ",
                      style: TextStyle(
                        color: Color(0xFF77381F),
                        fontWeight: FontWeight.w500,
                      ),
                    ...
                    Image.asset(
                      'assets/images/standingShortS1.jpg',
                      width: 400,
                    ),
                    SizedBox(
                      height: 20,
                    ...
                    Text(
                      "3. Engage your core to help lift your torso back up to the starting position and repeat on the opposite side.                                                                                                                                                                                                                                                                                                                                   ",
                      style: TextStyle(
                        color: Color(0xFF77381F),
                        fontWeight: FontWeight.w500,
                      ),
